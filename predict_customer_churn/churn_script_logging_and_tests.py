...
def test_eda(perform_eda):
    ...
    try:
        ...
        assert os.path.isfile("./images/eda/barplot_customer_marital_status.png")
...
def test_encoder_helper(encoder_helper):
    ...
    try:
        ...
        logging.error('Test encoder_helper: FAILED, number of features generated was not quite correct')
        raise err
...
def test_perform_feature_engineering(perform_feature_engineering):
    ...
    try:
        ...
        logging.error("Test perform_feature_engineering: FAILED, number of features in training and tests sets not correct")
        raise err
